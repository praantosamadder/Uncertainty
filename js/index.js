...
let gb = gradientBestFit(outputListX, outputListY);
let gw = gradientWorstFit(outputListX, outputListY, outputListXUnc, outputListYUnc);
console.log("Gradient: " + gb)
console.log("Y-intercept: " + yIntercept(outputListX, outputListY, gb))
console.log("Angle with x-axis: " + (gb).toDegree())
console.log("m of LOWF: " + gw)
console.log("m = " + gb.toFixed(3) + " ± " + Math.abs(gw - gb).toFixed(3))
